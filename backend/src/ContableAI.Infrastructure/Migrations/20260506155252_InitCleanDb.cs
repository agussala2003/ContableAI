        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: true),
                    Keyword = table.Column<string>(type: "text", nullable: false),
                    SuggestedAccount = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<string>(type: "text", nullable: false),
                    StudioTenantId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AfipVouchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AfipVouchers_Companies_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountingRules_StudioTenantId",
                table: "AccountingRules",
                column: "StudioTenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AfipVouchers_CompanyId_Date_Amount_TaxName",
                table: "AfipVouchers",
                columns: new[] { "CompanyId", "Date", "Amount", "TaxName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RuleSuggestions_CompanyId_Status",
