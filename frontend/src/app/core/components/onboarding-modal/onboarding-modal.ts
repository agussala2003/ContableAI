...
export class OnboardingModal {
  ...
  readonly steps: OnboardingStep[] = [
    ...
    { n: '2', key: 'upload',  title: 'Subí el extracto bancario', desc: 'PDF, CSV o Excel. El banco se detecta automáticamente (BBVA, MercadoPago, Ualá y más).',   color: 'bg-sky-100 dark:bg-sky-500/20 text-sky-600 dark:text-sky-400'             },
